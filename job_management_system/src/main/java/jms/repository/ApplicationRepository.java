...
public interface ApplicationRepository extends JpaRepository<Application, Long> {
    ...
    // Lấy tất cả application trong khoảng createdAt, có thể lọc theo company ở Service
    List<Application> findByCreatedAtBetween(Instant start, Instant end);

    // Lấy tất cả OFFERED trong khoảng updatedAt (để tính avg time to offer); fallback sẽ xử lý ở Service nếu thiếu updatedAt
